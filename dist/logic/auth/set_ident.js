 ...
 */
function SetIdentity(request, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        const { statusCode } = yield client_1.clientInstance.textFetcher("/auth/student", client_1.default.postJsonRequest(request, yield client_1.default.authRequest(auth)));
