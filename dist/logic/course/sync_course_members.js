 ...
 */
function SyncCourseMembers(courseId, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        const { statusCode } = yield client_1.clientInstance.textFetcher(`/course/sync/${courseId}`, client_1.default.postJsonRequest({}, yield client_1.default.authRequest(auth)));
