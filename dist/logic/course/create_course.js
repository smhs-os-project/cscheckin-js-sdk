...
function CreateCourse(classroomId, request, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data } = yield client_1.clientInstance.jsonFetcher(`/course/${classroomId}`, client_1.default.postJsonRequest(request, yield client_1.default.authRequest(auth)));
