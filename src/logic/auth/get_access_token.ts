...
import { AuthTokenRequest, Organization } from "../../types/auth/req_auth_token";
 ...
 */
export default async function GetAccessToken(organization: Organization, request: AuthTokenRequest) {
